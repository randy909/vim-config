...
hi NonText 		guifg=#a0a0a0 guibg=#444444 gui=none
...
hi Folded 		guibg=#303030 guifg=#a0a8b0  gui=none
hi Title		guifg=#ffffff guibg=NONE	gui=bold
hi Visual		guifg=#cccccc guibg=#2c2c2c gui=none
...
hi! perlVarPlain guifg=#A9AA8A  gui=none
